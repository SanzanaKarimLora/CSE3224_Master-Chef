...
public partial class cabbageRica : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string queryPrep = "select preparation_time from Recipe where recipe_id = 15";
        SqlCommand cmdprep = new SqlCommand(queryPrep, con);
        string outputpt = cmdprep.ExecuteScalar().ToString();
        lblPrep.Text = outputpt;

        string queryCate = "select category from Recipe where recipe_id = 15";
        ...
        string queryDescription = "select description from Recipe where recipe_id = 15";
