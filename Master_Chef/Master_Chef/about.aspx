...
<body>
    ...
    <section class="about-area section-padding-80">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h6 class="sub-heading pb-5">Cooking is the most talented one where every one cannot do it. for some of them cooking is hobbies and for some of the it is time pass.
...
.</h6>
                    ...
                    <p class="text-center">From this website, we will get a complete solution for those people who don’t know cooking and who have some interest on cooking. Our website is contain about all the food items with nutrition facts and preparation time. Besides, anyone can upload recipes and share those with others. A user can comment or give feedback of those recipes. By this website, we are going to gather different kinds of foods for all types of people in one place and make the user share their knowledge with others.
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-center">  Our website is contain about all the food items with nutrition facts and preparation time. Besides, anyone can upload recipes and share those with others. A user can comment or give feedback of those recipes. By this website, we are going to gather different kinds of foods for all types of people in one place and make the user share their knowledge with others.</p>
                </div>
            </div>
        </div>
    </section>
