<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boiledCh.aspx.cs" Inherits="boiledCh" %>
       ...
       <!-- <div class="receipe-post-search mb-80">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="receipe-slider owl-carousel">
                        <img src="foodpic/Boiled Chicken.jpg" alt="">
                        <img src="foodpic/Boiled Chicken.jpg" alt="">
                         <img src="foodpic/Boiled Chicken.jpg" alt="">
                    </div>
                </div>
        ...
        <div class="receipe-content-area">
            <div class="container">
                ...
                <!--Video part -->
<iframe width="697" height="392" src="https://www.youtube.com/embed/lZZCQI8ZqBw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="contact-form-area">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <asp:TextBox ID="txtNameC" runat="server" Width="350px" placeholder="Name"></asp:TextBox>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                       <!-- <input type="email" class="form-control" id="email" placeholder="E-mail">-->
                                        <asp:TextBox ID="txtEmailC" runat="server" Width="381px" placeholder="E-mail"></asp:TextBox>
                                    </div>
                                    <br />
                                    
                                    <div class="col-12">
                                       <!-- <textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="Comments"></textarea>-->
                                        <asp:TextBox ID="txtCmnt" runat="server" Height="65px" TextMode="MultiLine" Width="503px" placeholder="Comments"></asp:TextBox>
                                    </div>
                                    <div class="col-12">
